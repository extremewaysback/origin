# base.py/settings
# The base settings file that contains common and default settings
...
# Move settings files one directory level lower, so need BASE_DIR to point to hte parent directory to be correct
