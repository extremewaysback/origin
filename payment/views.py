...
def payment_process(request):
    order_id=request.session.get('order_id') #get the current order from session
...
@csrf_exempt #This decorator marks a view as being exempt from the protection ensureb by hte middleware
